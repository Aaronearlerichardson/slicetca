...
from ..core.decompositions import SliceTCA, PartitionTCA
...
def within_invariance(model: PartitionTCA,
                   objective_function: Callable = l2,
                   transformation: object = None,
                   learning_rate: float = 10**-2,
                   max_iter: int = 10000,
    ...
    if transformation is None: transformation = TransformationWithin(model)
